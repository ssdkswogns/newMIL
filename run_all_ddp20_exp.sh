...
for dataset in "${DATASETS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29500 main_cl_fix.py --dataset $dataset --model AmbiguousMIL --datatype mixed --bag_loss_w 0.3 --inst_loss_w 0.5 --proto_loss_w 0.2 --epoch_des 300 --num_epochs 1500 --proto_sim_thresh 0.8
done