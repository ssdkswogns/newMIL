...
def main():
    ...
    if args.dataset in ['ArticularyWordRecognition','BasicMotions','Cricket','ERing','HandMovementDirection','LSST','PhonemeSpectra','RacketSports','SelfRegulationSCP1','SelfRegulationSCP2','StandWalkJump','UWaveGestureLibrary']:
        batch = 64
        ...
        batch = 16
    elif args.dataset in ['Epilepsy','FaceDetection','Libras','PEMS-SF']:
        batch = 8
