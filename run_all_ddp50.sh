...
for dataset in "${DATASETS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29600 main_cl_exp.py --dataset $dataset --model AmbiguousMIL --datatype mixed --bag_loss_w 0.25 --inst_loss_w 0.25 --proto_loss_w 0.5 --epoch_des 20 --num_epochs 1500 --proto_win 10 --proto_tau 0.2
done